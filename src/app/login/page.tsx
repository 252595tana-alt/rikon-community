...
import { ArrowLeft, Check, Info, LockKeyhole, Mail, MessageCircle } from "lucide-react";
    ...
    <main id="main-content" className="login-page">
      ...
      <section className="login-panel">
        ...
        <div className="login-panel__inner">
          ...
          <p className="login-note" role="status"><Info aria-hidden="true" /><span><strong>参加機能は現在準備中です。</strong><br />いまは相談部屋のテーマや雰囲気をご覧いただけます。</span></p>
