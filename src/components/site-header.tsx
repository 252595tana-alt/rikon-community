    ...
    <header className="site-header">
      <div className="site-header__inner shell">
        ...
        <nav className="desktop-nav" aria-label="メインナビゲーション">
          ...
          <a href="https://252595tana-alt.github.io/rikon-support-navi-prototype/" target="_blank" rel="noreferrer">
            支援ナビ <ArrowUpRight aria-hidden="true" />
          </a>
          <a href="https://rikon-window.vercel.app" target="_blank" rel="noreferrer">
            りこんの窓口 <ArrowUpRight aria-hidden="true" />
          </a>
        </nav>
